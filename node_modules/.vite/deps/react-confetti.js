...
//#region node_modules/react-confetti/dist/react-confetti.min.js
var require_react_confetti_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(t, e) {
		...
		return function(t) {
			...
			function(t, e, n) {
						...
						value: function() {
							...
							if (this.rotateY += s, this.angle += this.angularSpin, this.context.save(), this.context.translate(this.x, this.y), this.context.rotate(this.angle), this.context.scale(1, this.rotateY), this.context.rotate(this.angle), this.context.beginPath(), this.context.fillStyle = this.color, this.context.strokeStyle = this.color, this.context.globalAlpha = a, this.context.lineCap = "round", this.context.lineWidth = 2, c && "function" == typeof c) c.call(this, this.context);
								...
								case r.Square:
									...
									break;
								case r.Strip: this.context.fillRect(-this.w / 6, -this.h / 2, this.w / 3, this.h);
							}
				...
				var O = {
					...
					function t(e, n) {
						...
						(function(t, e) {
							...
							r._options = d(d(d({}, { confettiSource: {
								x: 0,
								y: 0,
								w: r.canvas.width,
								h: 0
							} }), O), t), Object.assign(r, t.confettiSource);
				...
				var Q = a.a.forwardRef((function(t, e) {
					return a.a.createElement(N, P({ canvasRef: e }, t));
				}));
				e.default = Q;
			}
		]).default;
